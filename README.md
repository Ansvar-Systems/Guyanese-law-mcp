...
**Endpoint:** `https://mcp.ansvar.eu/law-gy/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add guyanese-law --transport http https://mcp.ansvar.eu/law-gy/mcp` |
...
```json
{
  "mcpServers": {
    "guyanese-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-gy/mcp"
    }
  }
}
```
