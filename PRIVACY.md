...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Guyanese legal professional rules.
...
- Law Society of Guyana rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/guyanese republic-law-mcp` locally — database queries stay on your machine
...
```bash
npx @ansvar/guyanese republic-law-mcp
```
...
```
Endpoint: https://guyanese republic-law-mcp.vercel.app/mcp
```
...
## Professional Obligations (Guyana)

### Law Society of Guyana and Advocates Act

Guyanese lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Guyana Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (Guyana Law Reports, LexisNexis East Africa)
...
2. Follow Guyanese government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/guyanese republic-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Guyana ethics guidance
